...
1. Использовать единый стиль оформления 
2. Учитывать правила и best practice оформления Markdown в странице [markdownguide.org](https://www.markdownguide.org/basic-syntax/)
