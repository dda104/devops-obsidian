...
2. Установить плагины из gitignore: `git`

3. Настроить плагин `git`
...
2. ✍️ **Опционально!** использовать единый стиль оформления:
...
2. ♻️ Неактуальные страницы следует помещать в папку `_Archive`, а не удалять
